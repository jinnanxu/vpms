<template>
  <div class="main-contain">
    <div class="profile-div">
      <el-row :gutter="20" v-if="userData.role==2">
        <el-col :span="6" class="profile-item meta"><div class="grid-content bg-purple">工作单位：</div></el-col>
        <el-col :span="12" class="profile-item">
          {{ userData.workDept }}
        </el-col>
      </el-row>
      <el-row :gutter="20" v-if="userData.role==2">
        <el-col :span="6" class="profile-item meta"><div class="grid-content bg-purple">职称：</div></el-col>
        <el-col :span="6" class="profile-item">
          <div class="grid-content bg-purple"><span class="role-div" style="font-size: 14px;">{{ userData.title }}</span></div>
        </el-col>
      </el-row>
    ...
    <el-dialog :title="title" :visible.sync="editFormVisible" width="30%" @click='closeDialog("edit")'>
      <el-form label-width="80px" ref="editForm" :model="editForm" :rules="rules">
        <el-form-item label="工作单位" prop="workDept" v-if="userData.role==2">
          <el-input size="small" v-model="editForm.workDept" auto-complete="off" placeholder="请输入工作单位"></el-input>
        </el-form-item>
        <el-form-item label="职称" prop="title" v-if="userData.role==2">
          <el-input size="small" v-model="editForm.title" auto-complete="off" placeholder="请输入职称"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleEdit() {
      ...
      this.editForm.workDept = this.userData.workDept
